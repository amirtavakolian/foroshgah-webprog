                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li class="angle-shape">
                                            ...
                                            <ul class="mega-menu">
                                                <li>
                                                    <a class="menu-title" href="#">{{ $category->parent->name }}</a>
                ...
                <div class="row flex-row-reverse text-right">
                    ...
                    <div class="col-lg-3 order-2 order-sm-2 order-md-1">
                        <div class="sidebar-style mr-30">
                            ...
                            <hr>
                            <form action="{{ route('productsCategory.attributes', ['category' => $category->slug]) }}" method="get" id="attributesForm">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="sidebar-widget-list-left">
                                                    <input type="checkbox" name="attributes[{{ $value->attribute_id }}]" value="{{ $value->value }}"><a href="#">{{ $value->value }}</a>
                            ...
                            <form action="{{ route('productsCategory.attributes', ['category' => $category->slug]) }}" method="get" id="variationsForm">
                                @foreach ($category->attributes as $attribute)
                                <div class="sidebar-widget mt-30">
                                    ...
                                    <div class="sidebar-widget-list mt-20">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="sidebar-widget-list-left">
                                                    <input type="checkbox" value="{{ $value->value }}" name="variations[{{ $value->attribute_id }}]"><a href="#">{{ $value->value }}</a>
                                                    <span class="checkmark"></span>
                                                </div>
                                            </li>
                                            @endforeach
                        ...
                        <div class="shop-bottom-area mt-35">
                            <div class="tab-content jump">
                                ...
                                <div class="row ht-products" style="direction: rtl;">
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="product-details.html" class="ht-product-image">
                                                        <img src="{{ asset('images/product/' . $attribute->product->primary_image) }}" alt="Universal Product Style" />
                                                    </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li>
                                                                <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="sli sli-magnifier"></i><span class="ht-product-action-tooltip"> مشاهده
                                                                        سریع
                                                                    </span></a>
                                                            </li>
                                                            <li>
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        ...
                                                        <h4 class="ht-product-title text-right">
                                                            <a href="product-details.html">{{ $attribute->productname }}
                                                            </a>
                                                        </h4>
                                                        <div class="ht-product-price">
                                                            @if ($attribute->product->saleCheck)
                                                            <span class="new">
                                                                {{ $attribute->product->saleCheck->sale_price }}
                                                                تومان
                                                            </span>
                                                            <span class="old">
                                                                {{ $attribute->product->saleCheck->price }}
                                                                تومان
                                                            </span>
                                                            @else
                                                            <span class="new">
                                                                {{ $attribute->product->variation->price }}
                                                                تومان
                                                            </span>
                                                            @endif
                                                        </div>
                                    ...
                                    @foreach ($variations as $variationAttribute)
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        <!--Product Start-->
                                        <div class="ht-product ht-product-action-on-hover ht-product-category-right-bottom mb-30">
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="product-details.html" class="ht-product-image">
                                                        <img src="{{ asset('images/product/' . $variationAttribute->attribute->product->primary_image) }}" alt="Universal Product Style" />
                                                    </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li>
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        ...
                                                        <h4 class="ht-product-title text-right">
                                                            <a href="product-details.html">{{ $variationAttribute->attribute->product->name }}
                                                            </a>
                                                        </h4>
                                                        <div class="ht-product-price">
                                                            @if ($variationAttribute->attribute->product->saleCheck)
                                                            <span class="new">
                                                                {{ $variationAttribute->attribute->product->saleCheck->sale_price }}
                                                                تومان
                                                            </span>
                                                            <span class="old">
                                                                {{ $variationAttribute->attribute->product->saleCheck->price }}
                                                                تومان
                                                            </span>
                                                            @else
                                                            <span class="new">
                                                                {{ $variationAttribute->attribute->product->variation->price }}
                                                                تومان
                                                            </span>
                                                            @endif
                                                        </div>
