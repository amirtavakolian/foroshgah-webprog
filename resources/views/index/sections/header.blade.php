                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    @foreach ($category->children as $child)
                                                        <li><a
                                                                href="{{ url('/product/' . $child->slug) }}">{{ $child->name }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </li>
                        ...
                        <div class="cart-wrap">
                            <button class="icon-cart-active">
                                <span class="icon-cart">
                                    <i class="sli sli-bag" onclick="buyBasket(event)"></i>
                                ...
                                <form action="{{ route('cart.store') }}" method="post">
                                            ...
                                            @foreach (\Cart::getContent() as $product)
                                                <li class="single-shopping-cart">
                                                    <div class="shopping-cart-title">
                                                        ...
                                                        <input type="hidden" name="productAmount[]" value="${value.productAmount}">
                                                        <span style="color:red; display:block; direction:rtl;">{{ !$product->conditions ? "" : round($product->conditions->sale_price / $product->conditions->price * 100) ."% تخفیف"}}</span>
                                                        <input type="hidden" name="productPrice[]" value="${price}">
                                                        <p> {{ $product->attributes->value }} :سایز</p>
                                                    </div>

                                                    <div class="shopping-cart-img">
                                                        <a href="#"><img alt="" style="width: 75%"
                                                                src="{{ asset('images/product/' . $product->associatedModel->primary_image) }}" /></a>
                                    ...
                                    <div class="shopping-cart-bottom">
                                        ...
                                        <div class="shopping-cart-total d-flex justify-content-between align-items-center"
                                            ...
                                            <span class="shop-total" name="totalPrice" style="direction: rtl">
                                                {{ number_format(\Cart::getTotal())  . "تومان"}}
                                            </span>
                                        </div>
                                        <div class="shopping-cart-btn btn-hover text-center">
                                            <input type="submit" value="ثبت سفارش" class="default-btn">
                                        </div>
                                </form>
                                <div class="shopping-cart-btn btn-hover text-center">
                            ...
                            <div class="shopping-cart-content">
                                ...
                                <ul style="height: 400px;">
                                    <li class="single-shopping-cart">
                                        ...
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt=""
                                                    src="{{ asset('images/cart/cart-1.svg') }}" /></a>
                                            <div class="item-close">
                                                <a href="#"><i class="sli sli-close"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <li class="single-shopping-cart">
                                        ...
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt=""
                                                    src="{{ asset('images/cart/cart-2.svg') }}" /></a>
                                            <div class="item-close">
                                                <a href="#"><i class="sli sli-close"></i></a>
                                            </div>
                                        </div>
